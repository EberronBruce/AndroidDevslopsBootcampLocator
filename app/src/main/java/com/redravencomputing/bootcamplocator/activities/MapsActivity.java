package com.redravencomputing.bootcamplocator.activities;
...
import com.redravencomputing.bootcamplocator.fragments.MainFragment;
...
public class MapsActivity extends FragmentActivity implements GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks, LocationListener {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        Log.v("DONKEY", "On Request Permissions Result");
        switch (requestCode) {
